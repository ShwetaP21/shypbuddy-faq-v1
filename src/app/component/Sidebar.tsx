...
export default function Sidebar({ onComponentChange, clearSearch}) {
// export default function Sidebar({ onComponentChange }) {
  ...
  const links = [
    { text: "Getting started", icon: <FaChartLine size={20}/>, component:'Website' },
    {
      text: "Orders",
    ...
    { text: "Shipment", icon: <FaTruckMoving size={20} />, component:"Shipment" },
