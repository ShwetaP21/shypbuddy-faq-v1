...
export interface DeliverytDisputeItem {
  question : String,
  answer : String | SubAnswer[],
  subquestion : String,
  subanswer : String
...
export interface BuddyShieldContactInfoItem{
  question : String,
  answer : String | SubAnswer[],
}
export interface ImpactsOnDeliveryItem{
  question : String,
  answer : String | SubAnswer[],
}
export interface ProblemServiceBasedItem{
  question : String,
  answer : String | SubAnswer[],
}
