...
function WeightDiscrepancyComponent() {
  return (
    <>
    <div className="flex-1 bg-white overflow-auto rounded-md py-5">
    <h1 className="text-2xl py-1 ml-1.5 font-bold text-slate-600">Weight Discrepancy</h1>
    <div className="divide-y divide-slate-200">
          {WeightDiscrepancyObj.map((item, index) => (
...
export default WeightDiscrepancyComponent