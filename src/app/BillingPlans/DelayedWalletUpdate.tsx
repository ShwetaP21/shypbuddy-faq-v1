...
export default function DelayedWalletUpdate() {
...
<h1 className="text-2xl py-1 ml-1.5 font-bold text-slate-600">Delayed Wallet Update</h1>
        <div className="divide-y divide-slate-200">
          {DelayedWalletUpdateObj.map((item, index) => (
